...
public class Facture extends javax.swing.JFrame {
    ...
    public void table() {
        String e[] = {"code_produit","reference","designation","rangement","fournisseur","remise","prix","stock"};
        rs = db.querySelect(e, "produit");
        tbl_res.setModel(new ResultSetTableModel(rs));
    }

    public void importer() {
        String e[] = {"num_facture","code_produit","reference","prix_vente","stock_utilisee","subtotal"};
        rs = db.fcSelectCommand(e, "vente", "num_facture='" + txtfac.getText() + "'");
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(0, 20, 990, 90);
        ...
        jButton2.setText("Ajouter à la vente");
        ...
        jButton5.setBounds(10, 70, 139, 30);
        ...
        tbl_ven.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "num_facture", "code_produit", "reference", "Prix de vente", "Stock ", "total "
            }
        ) {
            Class[] types = new Class [] {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (txtrech.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Veuillez compléter le champ de recherche");
        } else {
            if (comrech.getSelectedItem().equals("code_produit")) {
                String e[] = {"code_produit","reference","designation","rangement","fournisseur","remise","prix","stock"};
                rs = db.fcSelectCommand(e, "produit", "code_produit LIKE '" + txtrech.getText() + "' ");
                tbl_res.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("reference")) {
                String e[] = {"code_produit","reference","designation","rangement","fournisseur","remise","prix","stock"};
                rs = db.fcSelectCommand(e, "produit", "reference LIKE '" + txtrech.getText() + "' ");
                tbl_res.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("designation")) {
                String e[] = {"code_produit","reference","designation","rangement","fournisseur","remise","prix","stock"};
                rs = db.fcSelectCommand(e, "produit", "designation LIKE '" + txtrech.getText() + "' ");
                tbl_res.setModel(new ResultSetTableModel(rs));
                } else if (comrech.getSelectedItem().equals("rangement")) {
                String e[] = {"code_produit","reference","designation","rangement","fournisseur","remise","prix","stock"};
                rs = db.fcSelectCommand(e, "produit", "rangement LIKE '" + txtrech.getText() + "' ");
                tbl_res.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("fournisseur")) {
                String e[] = {"code_produit","reference","designation","rangement","fournisseur","remise","prix","stock"};
                rs = db.fcSelectCommand(e, "produit", "fournisseur LIKE '" + txtrech.getText() + "' ");
                tbl_res.setModel(new ResultSetTableModel(rs));
                } else if (comrech.getSelectedItem().equals("remise")) {
                String e[] = {"code_produit","reference","designation","rangement","fournisseur","remise","prix","stock"};
                rs = db.fcSelectCommand(e, "produit", "remise LIKE '" + txtrech.getText() + "' ");
                tbl_res.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("prix")) {
                String e[] = {"code_produit","reference","designation","rangement","fournisseur","remise","prix","stock"};
                rs = db.fcSelectCommand(e, "produit", "prix LIKE '" + txtrech.getText() + "' ");
                tbl_res.setModel(new ResultSetTableModel(rs));
                } else if (comrech.getSelectedItem().equals("stock")) {
                String e[] = {"code_produit","reference","designation","rangement","fournisseur","remise","prix","stock"};
                rs = db.fcSelectCommand(e, "produit", "stock LIKE '" + txtrech.getText() + "' ");
                tbl_res.setModel(new ResultSetTableModel(rs));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (txtcod.getText().equals("") || txtref.getText().equals("") || txtran.getText().equals("")
            ...
            JOptionPane.showMessageDialog(this, "Veuillez entrer vos données");
        } else if (txtfac.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Veuillez entrer le numéro de facture");
        } else {
            String[] e = {"num_facture","code_produit", "reference", "prix_vente", "stock_utilisee", "total"};
            String[] isi = {txtfac.getText(), txtcod.getText(), txtref.getText(), txtnou.getText(), txtsto.getText(), lbltot1.getText()};
            System.out.println(db.queryInsert("vente", e, isi));
            try {
                if (!test_stock()) { 
                    JOptionPane.showMessageDialog(this, "Le stock est epuisée");
                } else {
                    def(); //true
                    table(); //true
                }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(this, "Voulez vous vraiment supprimer cela?", "Attention", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
 ...
 Login l = new Login();
    ...
    public void cout() {
     ...
     public void total() {
      ...
      public void subtotal() {
        rs = db.exécutionQuery("SELECT SUM(total) as subtotal FROM vente WHERE num_facture = '" + txtfac.getText() + "'");
        try {
            rs.next();
    ...
    public void def() throws SQLException {
        ...
        String[] e = {"stock"};
        String[] isi = {a};
        System.out.println(db.queryUpdate("produit", e, isi, "code_produit='" + txtcod.getText() + "'"));
    }
