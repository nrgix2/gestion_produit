...
public class Produit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setBounds(20, 100, 90, 27);
        jPanel2.add(txtdes);
        ...
        jLabel14.setBounds(20, 150, 90, 27);
        jPanel2.add(txtid);
        ...
        jButton1.setBounds(0, 140, 135, 40);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (txtid.getText().equals("") || txtref.getText().equals("") || txtdes.getText().equals("")
            ...
            JOptionPane.showMessageDialog(this, "Veuillez entrer les informations complètes");
        } else {
            ...
            System.out.println(db.queryInsert("produit", e, inf));
            table();
            actualiser();
        }
...
if (txtrech.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Veuillez entrer des informations");
        } else {
